...
partial_model = xgb.train(xgb_params, dtrain, num_boost_round=100, evals=[(dval, 'valll')],
...
num_boost_round = partial_model.best_iteration
print(123)
model = xgb.train(dict(xgb_params), dtrain_all, num_boost_round=num_boost_round)
